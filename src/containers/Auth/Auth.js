...
checkValidation(value,rules){
    ...
    inputChangeHandler = (event,elementName) =>{
        ...
        controls[elementName].value = event.target.value;
        controls[elementName].valid = this.checkValidation(controls[elementName].value,controls[elementName].validation);
        controls[elementName].touched = true;*/
